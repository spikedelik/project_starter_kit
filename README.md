...
- **Behind-the-Scenes Work**: This kit is all about what people _see_ and _click on_. If you're building the "engine" of a website that users don't directly interact with, this isn't the right tool.
...
1.  **Get Your Project Files**:
    - **The Easy Way (Recommended if you know Git)**: If you're familiar with Git (a way to manage project files online), you can "clone" this project to your computer. This makes a perfect copy.
      ...
      - Type this command and press Enter:
        ...
        ```
        _(Replace `your-new-project-name` with what you want to call your project folder.)_
